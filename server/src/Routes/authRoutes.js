...
router.route("/updateAccountInfo").post(limiter, verifySession(['user', 'rep', 'admin', 'dispatch']), authController.updateAccountInfo);
router.route("/updateShippingInfo").post(limiter, verifySession(['user', 'rep', 'admin', 'dispatch']), authController.updateShippingInfo);
